...
if __name__ == "__main__":
    input_filename = "/home/weilong/workspace/chemsim-lammps/examples/water/water_vapor_simulation/fit_in_one_gpu/reference/final_config.data"  # Replace with your input file
    output_filename = f"final_config_filtered_227536_atoms.data"
